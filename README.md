...
## Dataset
We introduce **[BioSci-Fig](https://huggingface.co/datasets/Huang-AI4Medicine-Lab/BioSci-Fig)**, a dataset of compound scientific figures from biomedical papers designed for compound figure and caption decomposition, with inter-annotator agreement reported in the paper ([table correction](./IAA.md)).
